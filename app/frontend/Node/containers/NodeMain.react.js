...
class NodeMain extends Component {
  ...
  render () {
    ...
    const nodeEdges = superEdges.map(function (superEdge, i){
      ...
      return (
        <div key={i} className='default-card' style={{ padding:'5px 0px' }}>
          <EntityItem
            count={entityCount}
    ...
    return (
      <div style={{ backgroundColor:'white' }}>
        <Navbar />
        <div className="container" style={{ paddingTop:'40px', marginBottom: '40px', backgroundColor: 'white' }}>
          <div className='row'>
            <div className={['col-xs-12', 'col-sm-10', 'col-sm-offset-1', 'col-md-8', 'col-md-offset-2'].join(' ')}>
              <div style={{ display: 'block', overflow: 'hidden' }}>
                ...
                <div className="card-right-col" style={{ paddingLeft: '5px', paddingRight: '5px' }}>
                  ...
                  <a href={connectHref}>
                     <button type="button" className="btn btn-default invertibleButton" style={{ marginTop: '10px', border: '1px solid orange' }}>
                       Add a connection
                     </button>
                   </a>
                </div>
